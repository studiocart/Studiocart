    ...
    public function render_reports_page_content( $active_tab = '' )
    {
        ...
        ?>
                    ...
                    <form >
                        ...
                        <input type="text" name="date" id="reports-range" value="<?php 
        echo  $date ;
        ?>" />
                        <input class="button button-primary" type="submit" value="<?php 
        esc_html_e( 'Apply', 'ncs-cart' );
        ?>" /> &nbsp; 
                        <a id="customer_csv_export__" class="button customer_csv_export" href="<?php 
        echo  home_url() ;
        ?>/?sc-csv-export=reports&type=order&daterange=<?php 
        echo  $date ;
        ?>"><?php 
        esc_html_e( 'Export Orders', 'ncs-cart' );
        ?></a>
                    </form>
        ...
        if ( $date != '' ) {
            ...
            if ( count( $date ) == 1 ) {
                ...
                $argsfunded['date_query'] = array( array(
                    'year'  => $from->format( 'Y' ),
                    'month' => $from->format( 'm' ),
                    'day'   => $from->format( 'd' ),
                ) );
        ...
        ?>
                ...
                <div class="totals" style="flex-wrap: wrap;">
                    ...
                    <div class="total-sales column">
                        <div class="postbox">
                            <p><?php 
        esc_html_e( 'Total Sales', 'ncs-cart' );
        ?></p>
                            <h3><?php 
        sc_formatted_price( $carttotal['total'] );
        ?></h3>
                        </div>
                    </div>
                    ...
                    <div class="total-sales column">
                        <div class="postbox">
                            <p><?php 
        esc_html_e( 'Net Sales', 'ncs-cart' );
        ?></p>                           
                            <h3><?php 
        sc_formatted_price( $carttotal['total'] - $refunded_amount );
        ?></h3>
                        </div>
                    </div>
                    ...
                    <div class="total-downsells column">
                        <div class="postbox">
                            <p><?php 
        esc_html_e( 'Total Refunds', 'ncs-cart' );
        ?></p>
                            <h3><?php 
        echo  $refunded_time ;
        ?></h3>
                     ...
                     <div class="total-downsells column">
                        <div class="postbox">
                            <p><?php 
        esc_html_e( 'Amount Refunded', 'ncs-cart' );
        ?></p>
                            <h3><?php 
        sc_formatted_price( $refunded_amount );
        ?></h3>
                        </div>
                    </div>
        ...
        $gatewayLabels = [
            'paypal' => 'PayPal',
            'stripe' => 'Stripe',
            'cod'    => __( "Cash on Delivery", "ncs-cart" ),
        ];
        ...
        ?>
                    <div class="total-upsells column">
                        <div class="postbox">
                            <p><?php 
        esc_html_e( 'Avg Revenue per Customer', 'ncs-cart' );
        ?></p>
                            <h3><?php 
        sc_formatted_price( $avg_amt );
        ?></h3>
                        </div>
                    </div>
                    ...
                    <div class="total-orders column">
                        <div class="postbox">
                            <p><?php 
        esc_html_e( 'Transactions (main orders + upsells)', 'ncs-cart' );
        ?></p>
                            <h3><?php 
        ...
        ?></h3>
                    ...
                    <div class="total-bumps column">
                        <div class="postbox">
                            <p><?php 
        esc_html_e( 'Order Bumps', 'ncs-cart' );
        ?></p>
                            <?php 
        echo  ( !sc_fs()->is__premium_only() ? $upgrade_link : '<h3>' . $bumps['total'] . '</h3>' ) ;
        ?>
                        </div>
                    </div>
                    ...
                    <div class="total-upsells column">
                        <div class="postbox">
                            <p><?php 
        esc_html_e( 'Upsells', 'ncs-cart' );
        ?></p>
                            <?php 
        echo  ( !sc_fs()->is__premium_only() ? $upgrade_link : '<h3>' . $upsells['total'] . '</h3>' ) ;
        ?>
                        </div>
                    </div>
                    ...
                    <div class="total-downsells column">
                        <div class="postbox">
                            <p><?php 
        esc_html_e( '2nd Upsells/Downsells', 'ncs-cart' );
        ?></p>
                            <?php 
        echo  ( !sc_fs()->is__premium_only() ? $upgrade_link : '<h3>' . $downsells['total'] . '</h3>' ) ;
        ?>
                        </div>
                    </div>
                ...
                <div class="products">
                    <div class="product-list">
                        <h3><?php 
        esc_html_e( 'Sales by Product', 'ncs-cart' );
        ?></h3>
                        <?php 
        ...
        ?>
                    ...
                    <div class="product-list">
                        <h3><?php 
        esc_html_e( 'Refunds by Product', 'ncs-cart' );
        ?></h3>
                        <?php 
        ...
        ?>
                    ...
                    <div class="product-list">
                        <h3><?php 
        esc_html_e( 'Transactions by Payment Gateway', 'ncs-cart' );
        ?></h3>
                        <?php 
        ...
        ?>
                    ...
                    <div class="product-list">
                        <h3><?php 
        esc_html_e( 'Main Orders by Product', 'ncs-cart' );
        ?></h3>
                        <?php 
        foreach ( $main as $k => $v ) {
            if ( $k == 'total' ) {
